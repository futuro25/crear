                    ...
                    <tbody className="bg-white dark:bg-slate-800">
                      {
                        ...
                        dataFiltered.map((student) => (
                            <tr key={student._id}>
                              <td className="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">{student.name}</td>
                              <td className="border-b border-slate-100 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">{student.lastName}</td>
                              <td className="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">{getInsuranceName(student.healthInsurance)}</td>
